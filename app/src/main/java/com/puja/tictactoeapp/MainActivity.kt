                        ...
                        if (b3.text == "" && play) {
                            if (currentTurn % 2 == 0) {
                                ...
                                restart.setOnClickListener {
                                    ...
                                    c3.text = ""
                                    c3.setBackgroundColor(
                                        ContextCompat.getColor(
                                            this,
                                            R.color.bg_btn
                                        )
                                    )
                                    window.statusBarColor = getColor(R.color.bg_btn2)
                                    currentTurn = 0
                                    play = true
                                    ui()
